...
minCHUNK = 2048  # CHUNK load size
numChannels = 1;  # = Mono
numProcesses = 8;
numTasks = 3; # Set to non-zero value to refresh workers periodically
bridgePos = -3; #Last string segment before end
synthMode = 1; # Decreases norm to create another sound
spectrum = True;   #Toggle to turn on spectrum calculation and plotting after playing the sound
dampTime = 1.5; # Reduces sound after this time
damping = .05/minCHUNK; # Damping factor per iteration. Applied every CHUNK.
